      ...
      <div className="w-full lg:w-[80%] mx-auto px-4 sm:px-6 lg:px-8 space-y-8 md:space-y-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-base md:text-lg text-gray-600 mt-2.5 leading-relaxed max-w-3xl">
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-base font-semibold bg-gray-900 text-white hover:bg-gray-800 shadow-sm transition-colors cursor-pointer self-start sm:self-auto"
          >
            <Printer size={18} />
            ...
            {reports.map((report) => {
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-xl border p-6 shadow-sm transition-all duration-200 cursor-pointer flex items-center justify-between ${
                    isSelected
                ...
                >
                  <div>
                    <span className="text-xs md:text-sm font-bold text-amber-700 uppercase tracking-wider block mb-1.5">
                      {report.category}
                    </span>
                  ...
                  {isSelected && (
                    <ChevronRight size={22} className="text-gray-900 ml-2 shrink-0" />
                  )}
                </div>
              );
            })}
          ...
          <div className="lg:col-span-8 bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-gray-200">
              <div className="flex items-center gap-2.5 text-base font-mono text-gray-600">
                ...
                <span className="font-bold text-gray-900">DOSSIER: SUNRISE-ENG-{selectedReport.toUpperCase()}-2026</span>
              </div>
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-sm font-semibold bg-green-50 text-green-700 border border-green-200 self-start sm:self-auto">
                <BadgeCheck size={18} />
            ...
            {/* Document Title */}
            <div>
              <span className="text-xs md:text-sm font-medium uppercase tracking-wide text-gray-400 block mb-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 md:p-7">
                  ...
                  <div className="text-3xl md:text-4xl font-bold font-mono text-green-700 mt-1">
                    82%
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mt-3.5 mb-2 overflow-hidden">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 md:p-7">
                  ...
                  <div className="text-3xl md:text-4xl font-bold font-mono text-gray-900 mt-1 flex items-center justify-between">
                    <span>248 <span className="text-base font-normal text-gray-500">Personnel</span></span>
                    <Users size={26} className="text-gray-400" />
                  </div>
                  <p className="text-base text-gray-500 mt-3.5">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 flex items-center justify-between">
                  <div>
                    <h4 className="text-lg font-bold text-gray-900">Er. Rajesh Varma</h4>
                    <p className="text-base text-gray-500">Principal Site Engineer (Civil)</p>
                    <div className="inline-flex items-center gap-1.5 text-sm font-mono text-green-700 font-semibold mt-2.5">
                      <ShieldCheck size={18} />
                      <span>Digitally Signed · 20-09-2026</span>
                    </div>
                  </div>
                  <div className="w-14 h-14 rounded-full bg-gray-200 text-gray-700 font-bold flex items-center justify-center text-base">
                    RV
                  </div>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 flex items-center justify-between">
                  <div>
                    <h4 className="text-lg font-bold text-gray-900">Dr. V. K. Sanghavi</h4>
                    <p className="text-base text-gray-500">Chief Structural Consultant</p>
                    <div className="inline-flex items-center gap-1.5 text-sm font-mono text-green-700 font-semibold mt-2.5">
                      <ShieldCheck size={18} />
                      <span>Digitally Signed · 20-09-2026</span>
                    </div>
